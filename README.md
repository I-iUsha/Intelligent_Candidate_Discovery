...
The submission CSV has exactly 4 columns matching the required spec:

```
candidate_id,rank,score,reasoning
CAND_0002025,1,0.9495,Senior AI Engineer with 5.9 yrs; 11 AI core skills; response rate 0.80.
CAND_0018499,2,0.9448,Senior Machine Learning Engineer with 7.2 yrs; 11 AI core skills; response rate 0.61.
CAND_0079387,3,0.9430,AI Engineer with 6.9 yrs; 8 AI core skills; response rate 0.81.
```

- `score` — 4 decimal places, non-increasing, range 0.0–1.0
- `reasoning` — `"{Title} with {X} yrs; {N} AI core skills; response rate {R}."`
...
└─────────────────────┘
      ...
      ▼
┌─────────────────────┐
│  Stage 5: Reasoning │  Per-candidate reasoning in standard format:
│  Generation         │  "{Title} with {X} yrs; {N} AI core skills; response rate {R}."
└─────────────────────┘
      │
      ▼
   Top 100 CSV
